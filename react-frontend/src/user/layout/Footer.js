        ...
        <footer className="footer">
            <div className="footer-nav">
                <div className="footer-nav-inner">
                    <div className="footer-nav-inner1">
                    ...
                    <div className="footer-nav-inner2">
                        <div className="footer-nav-item">
                            <span className="nav-title">
                                <Link aria-label="U.S." to="#">U.S.</Link>
                            </span>
                    ...
                    <div className="footer-nav-inner3">
                        <div className="footer-nav-item">
                            <span className="nav-title">
                                <Link aria-label="U.S." to="#">U.S.</Link>
                            </span>
            ...
            <div className="footer-lower">
                <div className="footer-lower-social-icons">
                ...
                <div className="footer-lower-legal">
                    <div className="links">
                ...
                <div className="footer-lower-branding">
                    <h3>
